...
then 
	...
	mv data/raw/rrnDB-5.8_16S_rRNA.temp.flip.accnos data/raw/rrnDB-5.8_16S_rRNA.flip.accnos
	mv data/raw/rrnDB-5.8_16S_rRNA.temp.align_report data/raw/rrnDB-5.8_16S_rRNA.align_report
else
